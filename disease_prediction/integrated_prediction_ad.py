...
new_adata = new_adata[~new_adata.obs.AD.isna()]
...
mil.plot_losses(save = '/home/icb/zihe.zheng/projects/microglia/plots/seaad_rosmap_ad_mil_rna.pdf')
mil.get_model_output()

mil.save('/home/icb/zihe.zheng/projects/microglia/model_mil/seaad_rosmap_ad_mil_rna/')
...
adata_both.write_h5ad('/lustre/groups/ml01/projects/2024_microglia_zihe.zheng/integrated_data/seaad_rosmap_integrated_rna_harmonized_ad.h5ad')

# calculate scores on the query dataset
accuracy = accuracy_score(query.obs["AD"], query.obs["predicted_AD"])
print('accuracy', accuracy)

score = f1_score(query.obs["AD"], query.obs["predicted_AD"], average='macro')
print('F1_score', score)

cm = confusion_matrix(query.obs["AD"], query.obs["predicted_AD"])
print(cm)

balanced_acc = balanced_accuracy_score(query.obs["AD"], query.obs["predicted_AD"])
print('balanced accuracy', balanced_acc)

recalls = recall_score(query.obs["AD"], query.obs["predicted_AD"], average=None)
